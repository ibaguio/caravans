package com.otfe.performance_test;
...
public class PerformanceTestService extends Service{
	public static final String TARG_FILE = "targ_file";
	...
	public final class ServiceHandler extends Handler{
	    ...
	    public void handleMessage(Message msg) {
	    	...
	    	try{
	    		...
	    		/* ENCRYPTION */
	    		String ok;
	    		for (String algo : Utility.algorithms){
	    			bw.write("\n"+algo);
	    			long sum = 0;
	    			long t;
	    			/* Encryption */
	...
	public int onStartCommand(Intent intent, int flags, int startId){
		...
		String targ_path = intent.getStringExtra(TARG_FILE);
		fsize = intent.getStringExtra(FILE_SIZE);
		...
		this.test_count = intent.getIntExtra(TEST_COUNT, 3);
