...
public class Utility{
    ...
    public static final String SDCARD = Environment.getExternalStorageDirectory().getAbsolutePath();//.getRootDirectory().getAbsolutePath();
    public static final String algorithms[] = {Utility.AES,Utility.TWO_FISH,Utility.SERPENT};
